...
const CashBoxModal = (props) => {

  const {currentItem, showModal, openModal, addCashBox, currencies, defaultValue} = props;

  return (
    <div>
      <Modal isOpen={showModal} toggle={openModal} centered>
        <AvForm onValidSubmit={addCashBox} model={defaultValue}>
